...
2. If macOS blocks the app, right-click it and select **Open** (or run `xattr -cr Zekat.app` in Terminal)
3. The setup wizard walks you through configuring email sources, account numbers, and report delivery
4. Configuration is encrypted locally at `~/Library/Application Support/Zekat/config.enc`
