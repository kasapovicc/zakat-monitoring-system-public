...
2. Try to open `Zekat.app` — macOS will block it on first launch
...
5. To start automatically on login, click the Zekat menubar icon and enable **Launch at Login**
6. Configuration is encrypted locally at `~/Library/Application Support/Zekat/config.enc`
