...
Download the release zip from the [GitHub Releases](https://github.com/kasapovicc/zekat-monitoring-system-public/releases) page. No Python or dependencies required — the app is self-contained.

After unzipping, double-click `install-zekat.command` to clear the macOS security flag and open the app. Alternatively, open `Zekat.app` manually and go to **System Settings > Privacy & Security > Open Anyway**.
...
1. Download and unzip from [GitHub Releases](https://github.com/kasapovicc/zekat-monitoring-system-public/releases)
2. Double-click `install-zekat.command` to open the app (handles macOS security for you)
