...
macOS will block the app on first launch. To allow it: try to open `Zekat.app`, then go to **System Settings > Privacy & Security**, scroll down and click **"Open Anyway"**.
...
- **Launch at Login** — optional auto-start via menubar toggle
...
2. Open the app — if macOS blocks it, go to **System Settings > Privacy & Security > Open Anyway**
